var Index = function () {
    ...
    return {
        ...
        /*initCharts: function () {
            ...
            function showTooltip(title, x, contents) {
                $('<div id="tooltip" class="chart-tooltip"><div class="date">' + title + '<\/div><div class="label label-success">当日投资: ' + x + '%<\/div><\/div>').css({
                    position: 'absolute',
                    display: 'none',
                    top: y - 100,
                    width: 75,
                    ...
                    $("#site_statistics").bind("plothover", function (event, pos, item) {
                        ...
                        if (item) {
                            if (previousPoint != item.dataIndex) {
                                ...
                                showTooltip('24 Jan 2013', item.pageX);
                            }
                        } else {
                            $("#tooltip").remove();
                            previousPoint = null;

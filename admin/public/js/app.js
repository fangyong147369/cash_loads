...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li.li1 > a', function (e) {
            $(this).children('.arrow').addClass('open').parent().parent().siblings().children('a').children('.arrow').removeClass("open");
            $(this).addClass("active");
            $(this).parent().addClass("open").siblings().removeClass("open")
            $(this).parent().children('.sub-menu').slideDown(200, function () {
                handleSidebarAndContentHeight();
            }).parent().siblings().children('.sub-menu').slideUp(200, function () {
                handleSidebarAndContentHeight();
            });
            e.preventDefault();
        });
    ...
    /*var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li.li1 > a', function (e) {
            ...
            $(this).addClass("active");
            $(this).parent().addClass("open").siblings().removeClass("open")
            $(".page-sidebar li.li1 > a").next('.sub-menu').slideUp(300, function () {
                handleSidebarAndContentHeight();
            });
